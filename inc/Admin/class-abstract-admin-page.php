...
abstract class Abstract_Admin_Page {
	...
	public function get_menu_title() {
		return __( 'Woocommerce Order Utils', 'wc-order-utils' );
	}
	...
	public function get_page_title() {
		return __( 'Woocommerce Order Utils Settings', 'wc-order-utils' );
	}
	...
	public function get_plugins_page_title() {
		return __( 'Plugin page', 'wc-order-utils' );
	}
